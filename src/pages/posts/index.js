...
//Assets
import photo_profile from '../../assets/avatar_neutro.png';
            ...
            <div className='posts__div'>
                <div className='posts__div-left'>
                    ...
                    <div className='posts__div-left__description'>
                        <img
                            className='posts__div-left__description-photo'
                            src={photo_profile}
                            alt='foto-de-perfil'
                        />
                        <br />
                        <span className='posts__div-left__description-span1'>
                            SOBRE A AUTORA
                        </span>
                        <br />
                        <span className='posts__div-left__description-span2'>
                            Name Name
                        </span>
                        <br />
                        <span className='posts__div-left__description-span3'>
                            Sou veterinária há 5 anos, apaixonada pelo mundo
                            animal, principalmente os que estão sempre conosco
                            no dia a dia. Quando não estou no meu consultório ou
                            com meus pets, estou aqui escrevendo conteúdo para
                            vocês. Espero que você goste!
                        </span>
                        <br />
                        <img
                            className='posts__div-left__description-icon'
                            src={facebook}
                            alt='facebook'
                        />
                        <img
                ...
                <div className='posts__div-right'>
                    <div className='posts__div-right__title'>
                        <span className='posts__div-right__title-span1'>
                            Miau!
                        </span>
                        <br />
                        <span className='posts__div-right__title-span2'>
                            Seja bem-vinda(o) ao blog PetGatô! Confira nosso
